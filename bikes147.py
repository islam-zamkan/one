...
def get_filters():
    ...
    """
    print('come and explore some US bikeshare data')
    # getting city
    while True:
        cities= [
            'chicago',
        ...
        city= input("\n enter one of this ciy? ( New york city,Chicago, Washington) \n").lower()
        if city in cities:
            break
        else:
            print("\n not found! Please enter a valid city")    
    ...
    while True:
        ...
        month = input("\n enter one of this months ? (January, February, March, April, May, June)? or 'None' for no month\n").title()
        if month in months:
            break
        else:
            print("\n not found! Please enter a valid month")    
    ...
    while True:
        ...
        day = input("\n enter one of the days? (Saturday, Sunday,Monday, Tuesday, Wednesday, Thursday, Friday)? or 'None' for no day\n").title()         
        if day in days:
            break
        else:
            print("\n not found Please enter a valid day")    
...
def load_data(city, month, day):
    ...
    # check if month not None
    if month != 'None':
        # use the index of the months list to get the corresponding int
        months = ['January', 'February', 'March', 'April', 'May', 'June']
        month = months.index(month)+1
    # here we filter months  
        df = df[df['month']==month] 

     # check if day not None
    if day != 'None':
         # here we filter day
...
def time_stats(df,month,day):
    ...
    # here we show most common month
    if month =='None':
        del_month= df['month'].mode()[0]
        months= [
            'January',
            'February',
            'March',
        ...
        del_month= months[del_month-1]
        print("The most Popular month is",del_month)


     # here we show most common day
    if day =='None':
        del_day= df['day_of_week'].mode()[0]
        print("The most Popular day is",del_day)


    # here we show most common hour
    df['Start Hour'] = df['Start Time'].dt.hour
    del_hour=df['Start Hour'].mode()[0]
    print("The popular Start Hour is {}:00 hrs".format(del_hour))
